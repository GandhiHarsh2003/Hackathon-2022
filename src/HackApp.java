		...
		buttonOne.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				...
				JLabel instructions = new JLabel(
						"<html>Click on either of the three buttons to learn more about them. Once you are finished you can press the back button if you <br/> want to learn about other disabilities!</html>");
